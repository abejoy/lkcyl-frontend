...
const url = config.graphUriEndPoint;
...
const client = new ApolloClient({
  ...
  link: new HttpLink({
    uri: config.graphUriEndPoint, // Replace with your actual GraphQL endpoint
    headers: {
      'x-api-key': config.xApiKey, // Replace with your actual API key if needed
    }
  })
});
...
mutation AddTeam($teamName: String!, $managerEmail:String!, $captainName:String!, $captainEmail:String! $selectedColor:Color! $tournamentGender:Gender!, $unit:String!, $players:[String]!, $managerName:String!, $contactMessage:String!, $captainPhone:String!, $managerPhone:String!) {
    addTeam(
        teamName: $teamName
...
export const submitForm = async (formdata) => {
    ...
    const {teamName, managerEmail, captainName, captainEmail, selectedColor, tournamentGender, unit, players, managerName, captainPhone, managerPhone} = formdata
    const { data } = await client.mutate({
        mutation: ADD_TEAM_MUTATION,
        variables: {teamName, managerEmail, captainName, captainEmail, selectedColor, tournamentGender, unit, players, managerName, contactMessage, captainPhone, managerPhone}
    });
    return data.addTeam
}
